...
- `US-000-clerk-auth` (high-risk, planned) —
  [epics/E00-auth/US-000-clerk-auth/](epics/E00-auth/US-000-clerk-auth/overview.md).
  Clerk authentication (Email + Google) + local `User` record.
